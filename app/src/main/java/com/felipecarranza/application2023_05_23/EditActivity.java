...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbEntries dbEntries = new DbEntries(EditActivity.this);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!txt_title.getText().toString().isEmpty() && !txt_content.getText().toString().isEmpty()) {
                    ...
                    if (edit_result) {
                        Toast.makeText(EditActivity.this, "Entrada editada correctamente", Toast.LENGTH_SHORT).show();
                        navigateToMainActivity();
                    } else {
                        Toast.makeText(EditActivity.this, "Error al editar la entrada", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(EditActivity.this, "Debes llenar todos los campos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
